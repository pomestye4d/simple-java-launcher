 ...
 */
public final class SjlExtNodeTuple {

  private final SjlExtNode keyNode;
  private final SjlExtNode valueNode;

  public SjlExtNodeTuple(SjlExtNode keyNode, SjlExtNode valueNode) {
   ...
   */
  public SjlExtNode getValueNode() {
    return valueNode;
  }
