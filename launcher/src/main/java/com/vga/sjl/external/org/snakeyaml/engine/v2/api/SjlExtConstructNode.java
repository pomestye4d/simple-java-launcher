 ...
 */
public interface SjlExtConstructNode {
   ...
   */
  Object construct(SjlExtNode node);
   ...
   */
  default void constructRecursive(SjlExtNode node, Object object) {
    if (node.isRecursive()) {
      throw new IllegalStateException("Not implemented in " + getClass().getName());
    } else {
      throw new SjlExtYamlEngineException("Unexpected recursive structure for Node: " + node);
    }
  }
}
