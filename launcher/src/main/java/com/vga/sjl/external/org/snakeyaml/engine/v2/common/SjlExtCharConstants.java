...
public final class SjlExtCharConstants {
  ...
  public static final SjlExtCharConstants LINEBR = new SjlExtCharConstants(LINEBR_S);
  public static final SjlExtCharConstants NULL_OR_LINEBR = new SjlExtCharConstants(NULL_OR_LINEBR_S);
  public static final SjlExtCharConstants NULL_BL_LINEBR = new SjlExtCharConstants(NULL_BL_LINEBR_S);
  public static final SjlExtCharConstants NULL_BL_T_LINEBR = new SjlExtCharConstants(NULL_BL_T_LINEBR_S);
  public static final SjlExtCharConstants NULL_BL_T = new SjlExtCharConstants(NULL_BL_T_S);
  // prefix may contain ,[]
  public static final SjlExtCharConstants URI_CHARS_FOR_TAG_PREFIX = new SjlExtCharConstants(URI_CHARS_SUFFIX_S + ",[]");
  public static final SjlExtCharConstants URI_CHARS_FOR_TAG_SUFFIX = new SjlExtCharConstants(URI_CHARS_SUFFIX_S);

  public static final SjlExtCharConstants ALPHA = new SjlExtCharConstants(ALPHA_S);

  private static final int ASCII_SIZE = 128;
  boolean[] contains = new boolean[ASCII_SIZE];

  private SjlExtCharConstants(String content) {
