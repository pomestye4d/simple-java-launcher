 ...
 * IOException}
 */
public abstract class SjlExtYamlOutputStreamWriter extends OutputStreamWriter implements
        SjlExtStreamDataWriter {

  public SjlExtYamlOutputStreamWriter(OutputStream out, Charset cs) {
    super(out, cs);
  }
