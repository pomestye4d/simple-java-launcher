...
/**
 * Exception thrown by the {@link SjlExtScanner} implementations in case of malformed input.
 */
public class SjlExtScannerException extends SjlExtMarkedYamlEngineException { //NOSONAR
   ...
   */
  public SjlExtScannerException(String context, Optional<SjlExtMark> contextMark, String problem,
                                Optional<SjlExtMark> problemMark) {
    super(context, contextMark, problem, problemMark, null);
  }

  public SjlExtScannerException(String problem, Optional<SjlExtMark> problemMark) {
