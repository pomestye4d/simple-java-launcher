 ...
 */
public class SjlExtAnchorNode extends SjlExtNode {

  private final SjlExtNode realNode;

  public SjlExtAnchorNode(SjlExtNode realNode) {
  ...
  public SjlExtNodeType getNodeType() {
    return SjlExtNodeType.ANCHOR;
  }

  public SjlExtNode getRealNode() {
    return realNode;
  }
}
