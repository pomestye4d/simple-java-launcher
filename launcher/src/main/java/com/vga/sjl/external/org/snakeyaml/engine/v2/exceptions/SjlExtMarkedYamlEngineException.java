...
public class SjlExtMarkedYamlEngineException extends SjlExtYamlEngineException {

  private final String context;
  private final Optional<SjlExtMark> contextMark;
  private final String problem;
  private final Optional<SjlExtMark> problemMark;

  protected SjlExtMarkedYamlEngineException(String context, Optional<SjlExtMark> contextMark, String problem,
                                            Optional<SjlExtMark> problemMark, Throwable cause) {
  ...
  public Optional<SjlExtMark> getContextMark() {
    return contextMark;
  }
  ...
  public Optional<SjlExtMark> getProblemMark() {
    return problemMark;
  }
}
