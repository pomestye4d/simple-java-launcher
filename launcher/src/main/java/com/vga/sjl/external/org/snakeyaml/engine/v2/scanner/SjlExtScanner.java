...
import com.vga.sjl.external.org.snakeyaml.engine.v2.tokens.SjlExtToken;

import java.util.Iterator;

/**
 * This interface represents an input stream of {@link SjlExtToken}s.
 * <p>
 ...
 */
public interface SjlExtScanner extends Iterator<SjlExtToken> {
   ...
   * @throws SjlExtScannerException Thrown in case of malformed input.
   */
  boolean checkToken(SjlExtToken.ID... choices);
